...
if (GROMACS_LIBRARY)
    ...
    if(PC_GROMACS_CFLAGS_OTHER)
      ...
      endforeach(LIB)
		...
		if ( NOT ("${GMX_DEP_LIBRARIES}" MATCHES "fftw3") AND ${PC_GROMACS_VERSION} VERSION_GREATER "4.6.0" AND ${PC_GROMACS_VERSION} VERSION_LESS "2016" )
			find_library(FFTW fftw3f HINTS ${FFTW_LIB})
			if (FFTW)
				message(STATUS "Found fftw library: ${FFTW}")
				list(APPEND GMX_DEP_LIBRARIES ${FFTW})
		...
		endif ( NOT ("${GMX_DEP_LIBRARIES}" MATCHES "fftw3") AND ${PC_GROMACS_VERSION} VERSION_GREATER "4.6.0" AND ${PC_GROMACS_VERSION} VERSION_LESS "2016" )

		if(${PC_GROMACS_VERSION} VERSION_EQUAL "5.0" OR ${PC_GROMACS_VERSION} VERSION_GREATER "5.0" AND ${PC_GROMACS_VERSION} VERSION_LESS "2016" )
		...
		endif(${PC_GROMACS_VERSION} VERSION_EQUAL "5.0" OR ${PC_GROMACS_VERSION} VERSION_GREATER "5.0" AND ${PC_GROMACS_VERSION} VERSION_LESS "2016" )
